...
fun SettingsContent(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("Retention preset", style = MaterialTheme.typography.titleMedium)
            ...
            Text(
                "Higher retention schedules cards more often.",
...
@Preview(name = "Spaced repetition settings", showBackground = true)
@Composable
private fun SettingsPreview() {
    AzriTheme {
        SettingsContent(
            ...
            onSetPreset = {}, onSetNewCardsPerDay = {}, onSetMaxReviewsPerDay = {}, onBack = {},
        )
    }
}
